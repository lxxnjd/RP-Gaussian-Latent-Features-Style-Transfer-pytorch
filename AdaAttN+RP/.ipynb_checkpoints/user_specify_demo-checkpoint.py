...
transformer_path = './checkpoins/AdaAttN/latest_net_transformer.pth'
...
content_path = './datasets/contents/14.jpg'
style_path = './datasets/styles/3314.jpg'
...
with torch.no_grad():
    style = read_img(style_path, h=128, w=128).to(device)
    content = read_img(content_path, h=128, w=128).to(device)
